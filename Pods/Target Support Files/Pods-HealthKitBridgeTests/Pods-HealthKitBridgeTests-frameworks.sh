...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HealthKitBridge/HealthKitBridge.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PryvSwiftKit/PryvSwiftKit.framework"
